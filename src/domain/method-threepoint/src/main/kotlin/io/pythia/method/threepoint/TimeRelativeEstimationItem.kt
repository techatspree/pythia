...
import io.pythia.model.LeafDiffField
import io.pythia.model.PertCalculation
...
data class TimeRelativeEstimationItem(
    ...
    // `unit` comes last, matching the order the history panel has always shown.
    @JsExport.Ignore
