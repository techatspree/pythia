...
import io.pythia.method.bucketsampled.BucketMethodModule
import io.pythia.method.bucketsampled.BucketSampledSessionSupport
import io.pythia.method.threepoint.ThreePointMethodModule
import io.pythia.method.threepoint.ThreePointSessionSupport
...
object StandardMethods {
    ...
    /**
     * Idempotent: registration overwrites by [io.pythia.method.EstimationMethod],
