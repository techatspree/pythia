...
import io.pythia.domain.session.ParticipantRole
import io.pythia.domain.session.SessionItem
import io.pythia.domain.session.SessionItemStatus
import io.pythia.domain.session.SessionParticipant
import io.pythia.domain.session.SessionPhase
import io.pythia.domain.session.SessionStatus
...
import io.pythia.method.bucketsampled.AssignmentResult
import io.pythia.method.bucketsampled.BucketSampledSessionResult
import io.pythia.method.bucketsampled.BucketVoteInput
import io.pythia.method.bucketsampled.EstimatorBucketAssignment
import io.pythia.method.bucketsampled.SampleTriple
import io.pythia.method.threepoint.PertReduction
import io.pythia.method.threepoint.PertVoteInput
...
import io.pythia.repository.EstimationSessionRepository
import io.pythia.repository.SessionVoteRepository
import io.pythia.rest.dto.AggregateDto
import io.pythia.rest.dto.AssignmentConflictDto
import io.pythia.rest.dto.BucketAssignmentDto
import io.pythia.rest.dto.EstimationNodeUpdateDto
import io.pythia.rest.dto.ParticipantDto
import io.pythia.rest.dto.SessionDto
import io.pythia.rest.dto.SessionItemDto
import io.pythia.rest.dto.TripleDto
import io.pythia.rest.dto.VoteDto
import io.pythia.rest.dto.toDto
...
class EstimationSessionService(
    ...
    private fun draftLeafDescriptions(session: EstimationSession): Map<String, String?> {
        ...
        fun index(node: io.pythia.domain.draft.DraftEstimationNode) {
