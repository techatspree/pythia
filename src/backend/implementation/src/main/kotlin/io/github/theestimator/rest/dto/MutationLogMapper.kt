...
import io.github.theestimator.model.mutation.AdditionalCostAdded
import io.github.theestimator.model.mutation.AdditionalCostChanged
import io.github.theestimator.model.mutation.AdditionalCostRemoved
import io.github.theestimator.model.mutation.ChangeDescription
import io.github.theestimator.model.mutation.EffortDriverAdded
import io.github.theestimator.model.mutation.EffortDriverChanged
import io.github.theestimator.model.mutation.EffortDriverRemoved
import io.github.theestimator.model.mutation.NodeAdded
import io.github.theestimator.model.mutation.NodeMoved
import io.github.theestimator.model.mutation.NodeRemoved
import io.github.theestimator.model.mutation.NodeRenamed
import io.github.theestimator.model.mutation.NodeValueChanged
import io.github.theestimator.model.mutation.NotesChanged
import io.github.theestimator.model.mutation.OtherChange
import io.github.theestimator.model.mutation.ParameterChanged
import io.github.theestimator.model.mutation.PhaseAdded
import io.github.theestimator.model.mutation.PhaseChanged
import io.github.theestimator.model.mutation.PhaseRemoved
import io.github.theestimator.model.mutation.Truncated
import io.github.theestimator.model.mutation.diffSummary
    ...
    return EstimationVersion(
        ...
        additionalCosts = (additionalCosts ?: emptyList()).map {
            AdditionalCost(
                ...
                amount = it.amount,
                type = io.github.theestimator.model.AdditionalCostType.valueOf(it.type.name),
